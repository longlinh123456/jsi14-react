...
function PageNotFound() {
	return <div className="flex h-screen w-full flex-col items-center justify-center bg-[#1A2238]">
		...
		<button className="mt-5">
			...
			>
				<span
					className="absolute inset-0 translate-x-0.5 translate-y-0.5 bg-[#FF6A3D] transition-transform group-hover:translate-y-0 group-hover:translate-x-0"
				></span>
